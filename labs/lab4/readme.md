...
```
_Note: EKS labs should use th external public IP of a node and open the necessary ports on the securitygroups.<br>
       For KIND clusters, run **docker run -it --network kind xxradar/hackon** to issue the commands_
```
